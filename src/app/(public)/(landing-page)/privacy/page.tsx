  ...
  return (
    <article className='bg-gray-100 p-8 flex-1'>
      ...
      <p className='text-gray-800'>
        ...
        optio, provident neque harum, assumenda voluptatem nihil repellat magnam
        expedita cum deserunt.
      </p>
      <p className='text-gray-800'>
        ...
        quaerat doloremque voluptate suscipit ipsum repudiandae fugit quibusdam.
        Voluptates, qui in?
      </p>
      <p className='text-gray-800'>
      ...
      <p className='text-gray-800'>
        ...
        maiores laboriosam delectus sit iste magnam doloribus a dolorem sunt non
        veniam, voluptatum ipsa deserunt omnis quibusdam maxime quo temporibus!
      </p>
      <p className='text-gray-800'>
        ...
        sapiente dicta quo tempore inventore sint distinctio molestias obcaecati
        architecto.
      </p>
      <p className='text-gray-800'>
